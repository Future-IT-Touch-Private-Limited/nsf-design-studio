export   const serviceData = [
    ...
    {
      srNo: "1",
      question: "What is the typical process for starting a residential interior design project?",
      answer:
    ...
    {
      srNo: "2",
      question: "How long does a residential interior design project usually take?",
      answer:
    ...
    {
      srNo: "4",
      question: "Do you only work on full home designs, or also individual rooms?",
      answer:
    ...
    {
      srNo: "6",
      question: "Do you help with purchasing and setting up furniture and décor?",
      answer:
    ...
    {
      srNo: "7",
      question: "Can you incorporate my current furniture into the new design?",
      answer:
   ...
   faq: [
    {
      srNo: "1",
      question: "What is your approach to starting a commercial interior design project?",
      answer:
    ...
    {
      srNo: "2",
      question: "How long does a commercial interior design project typically take?",
      answer:
    ...
    {
      srNo: "3",
      question: "Can you design within a specific budget for commercial spaces?",
      answer:
    ...
    {
      srNo: "6",
      question: "Do you manage furniture, fixtures, and equipment (FF&E) procurement?",
      answer:
    ...
    {
      srNo: "7",
      question: "Can you design around existing branding and company guidelines?",
      answer:
    ...
    {
      srNo: "1",
      question: "How do you choose the right furniture and décor for my space?",
      answer:
    ...
    {
      srNo: "4",
      question: "Do you handle the purchasing of furniture and décor items?",
      answer:
    ...
    {
      srNo: "5",
      question: "Can you suggest décor pieces that match a specific theme or style?",
      answer:
    ...
    {
      srNo: "7",
      question: "Do you offer eco-friendly or sustainable furniture options?",
      answer:
    ...
    {
      srNo: "1",
      question: "What is a modular kitchen and how is it different from a traditional kitchen?",
      answer:
    ...
    {
      srNo: "2",
      question: "Can you customize the modular kitchen to fit my space and needs?",
      answer:
    ...
    {
      srNo: "3",
      question: "What materials do you use for modular kitchen cabinets and countertops?",
      answer:
    ...
    {
      srNo: "4",
      question: "How long does it take to complete a modular kitchen design project?",
      answer:
    ...
    {
      srNo: "5",
      question: "Do you provide options for built-in appliances and accessories?",
      answer:
    ...
    {
      srNo: "6",
      question: "Can you help with lighting and ventilation for the kitchen?",
      answer:
    ...
    {
      srNo: "1",
      question: "What is the purpose of a false ceiling in interior design?",
      answer:
    ...
    {
      srNo: "2",
      question: "Can you customize lighting based on the room’s function and mood?",
      answer:
    ...
    {
      srNo: "4",
      question: "Is it possible to install a false ceiling in an already finished space?",
      answer:
    ...
    {
      srNo: "5",
      question: "What types of lighting can be integrated into false ceilings?",
      answer:
    ...
    {
      srNo: "6",
      question: "How do false ceilings affect room temperature and energy efficiency?",
      answer:
    ...
    {
      srNo: "7",
      question: "Can I change the lighting easily in a false ceiling setup?",
      answer:
